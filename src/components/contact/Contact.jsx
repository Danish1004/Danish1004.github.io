          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                danishsharma13255@gmail.com
              </span>

              <a
                href="mailto:danishsharma13255@gmail.com"
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">60052-60945</span>

              <a
                href="https://api.whatsapp.com/send?phone=6005260945&text=Hello, more Information!"
                className="contact_button"
              >
                Write Me{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
